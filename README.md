...
![Image of concert-this](https://github.com/AndreaLabis/liri-node-app/edit/master/assets/images/concert image.jpg)
...
![Image of spotify-this-song](https://github.com/AndreaLabis/liri-node-app/edit/master/assets/images/spotify image.jpg)
  
  
## "movie-this"**
This command used the OMBD API. An **axios.get** command sent the search request and the results were logged to the console.

![Image of movie-this](https://github.com/AndreaLabis/liri-node-app/edit/master/assets/images/movie image.jpg)
